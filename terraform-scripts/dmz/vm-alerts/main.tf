...
description = "Map of VM name to Memory alert resource ID (DMZ)."
value = module.vm_alerts.memory_alert_ids
}

output "disk_alert_ids" {
description = "Map of VM name to OS Disk Read alert resource ID (DMZ)."
value = module.vm_alerts.disk_alert_ids
}

output "network_alert_ids" {
description = "Map of VM name to Network In alert resource ID (DMZ)."
